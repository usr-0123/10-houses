package com.example.nyumbakumitool.ui.Chats;
...
import com.example.nyumbakumitool.ChatsNotificationHelper;
import com.example.nyumbakumitool.R;
import com.example.nyumbakumitool.ui.Users.UserModel;
import com.example.nyumbakumitool.ui.messages.MessageModel;
import com.example.nyumbakumitool.ui.messages.MessagesAdapter;
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(ChatActivity.this, "Error fetching user info", Toast.LENGTH_SHORT).show();
                }
            }
