...
public class NotificationHelper {
    ...
    public static final String CHANNEL_ID = "reports_channel_id";
    ...
    public static void createNotificationChannel(Context context) {
        ...
        channel.setDescription("Notification channel for reports.");
    ...
    public static void showNotification(Context context, String sender, String message, long timestamp) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_report_notification)
