...
import com.example.nyumbakumitool.ui.Groups.GroupActivity;

public class ChatsNotificationHelper {

    public static final String CHANNEL_ID = "chats_channel_id";
    ...
    public static void createNotificationChannel(Context context) {
        ...
        channel.setDescription("Notification channels for chat messages.");
